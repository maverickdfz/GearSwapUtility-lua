...
function get_sets()
    ...
    local setsUtil = include('SAM-sets')
...
function job_post_precast(spell, action, spellMap, eventArgs)
	if spell.type:lower() == 'weaponskill' then
		if state.Buff.Sekkanoki then
			equip(sets.buff.Sekkanoki or {})
		end
		if state.Buff['Meikyo Shisui'] then
			equip(sets.buff['Meikyo Shisui'] or {})
		end
	end
    if spell.english == "Seigan" then
        ...
        if state.HybridMode.value == 'PDT' or state.PhysicalDefenseMode.value == 'PDT' then
            equip(sets.thirdeye or {})
        else
            equip(sets.seigan or {})
        end
    end
